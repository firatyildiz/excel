...
public section.
  ...
  constants C_FORMAT_CURRENCY_GBP_SIMPLE type ZEXCEL_NUMBER_FORMAT value '[$Â£-809]#,##0.00'. "#EC NOTEXT
  constants C_FORMAT_CURRENCY_PLN_SIMPLE type ZEXCEL_NUMBER_FORMAT value '#,##0.00\ "zÅ"'. "#EC NOTEXT
