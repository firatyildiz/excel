...
method set_defaults.
    ...
    modify_font( iv_type = c_major iv_script = 'Jpan' iv_typeface = 'ï¼­ï¼³ ï¼°ã´ã·ãã¯' ).
    modify_font( iv_type = c_major iv_script = 'Hang' iv_typeface = 'ë§ì ê³ ë' ).
    modify_font( iv_type = c_major iv_script = 'Hans' iv_typeface = 'å®ä½' ).
    modify_font( iv_type = c_major iv_script = 'Hant' iv_typeface = 'æ°ç´°æé«' ).
    ...
    modify_font( iv_type = c_minor iv_script = 'Jpan' iv_typeface = 'ï¼­ï¼³ ï¼°ã´ã·ãã¯' ).
    modify_font( iv_type = c_minor iv_script = 'Hang' iv_typeface = 'ë§ì ê³ ë' ).
    modify_font( iv_type = c_minor iv_script = 'Hans' iv_typeface = 'å®ä½' ).
    modify_font( iv_type = c_minor iv_script = 'Hant' iv_typeface = 'æ°ç´°æé«' ).
